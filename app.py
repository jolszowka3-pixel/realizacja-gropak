...
/* TABELE - PRZYWRÓCENIE NORMALNEGO UKŁADU */
[data-testid="stHorizontalBlock"]:has(> div:nth-child(5)):not(:has(> div:nth-child(7))) {
    gap: 0.5rem !important; /* Przywracamy odstępy w tabelach realizacji */
}

    ...
    with cols[i]:
        ...
        for p in dane["przyjecia"]:
            try:
                ...
                if pd == dv and pm == mv:
                    towar_s = str(p.get('towar','')).replace('"', '&quot;')
